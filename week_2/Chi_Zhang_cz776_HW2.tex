...
\begin{tikzpicture}
\begin{axis}[
 domain=0:30,xlabel=\begin{math}V_{in}\end{math},
ylabel=\begin{math}V_X\end{math},
]
\addplot[
color=blue]
{(2.5+0.3(x-0.16)^2)/(1-0.03*(x-0.16)^2)};
\end{axis}
\end{tikzpicture}
\subsection*{b}
\begin{equation}
\begin{split}
 \frac{2.5 - 2.4R_1\frac{W}{L}}{1 + 0.24R_1 \frac{W}{L}} &= 1.5\\
 \frac{W}{L} &= \frac{1}{2.76R_1}
 \end{split}
\end{equation}
